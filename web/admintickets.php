                                        ...
                                        <div class="container">
                                            <form method="post" id="addMessage">
                                                ...
                                                <div class="form-group">
                                                    <textarea class="form-control pl-2 my-0" name="message" rows="15" placeholder="Deine Antwort"></textarea>
                                                </div>
        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header">
                            <h4 class="card-title float-left"><?= $_LANG['MENU_ADMINTICKETS'] ?></h4>
                                    ...
                                    if (\smnbots\Auth::getInstance()->isAdmin()){
                                        ...
                                        switch (strtolower($_GET['filter'])){
                                            case 'all':
                                                ...
                                                break;
                                            default:
                                                $list = \smnbots\ticket::ticketliststs(2);
                                                $list = array_merge($list,\smnbots\ticket::ticketliststs(2));
                                                $list = array_merge($list,\smnbots\ticket::ticketliststs(2));                                                
					    break;
                                        }
                                    } else {
